...
extension MoreViewController: SideMenuViewControllerDelegate {
...
//            self.showViewController(viewController: UINavigationController.self, storyboardId: "HomeNavID")
        case 1:
            // Profile
            let storyboard = UIStoryboard(name: "Main", bundle: Bundle.main)
            let profileModalVC = storyboard.instantiateViewController(withIdentifier: "ProfileViewController") as? ProfileViewController
            present(profileModalVC!, animated: true, completion: nil)
        case 2:
            // Settings
            let storyboard = UIStoryboard(name: "Main", bundle: Bundle.main)
            let profileModalVC = storyboard.instantiateViewController(withIdentifier: "SettingsViewController") as? SettingsViewController
            present(profileModalVC!, animated: true, completion: nil)

        case 3:
            // Like us on facebook
            let safariVC = SFSafariViewController(url: URL(string: "https://www.linkedin.com/in/krishna-kushwaha/")!)
...
extension MoreViewController: UIGestureRecognizerDelegate {
